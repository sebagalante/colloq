defmodule ColloqWeb.Components.Lucide do
  ...
  defp icon_paths("sliders-horizontal"),
    do: [
  ...
  defp icon_paths("palette"),
    do: [
      ...
      ~s(<path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/>)
    ]

  defp icon_paths("user"),
    do: [
  ...
  defp icon_paths("chevron-right"),
    do: [
      ~s(<path d="m9 18 6-6-6-6"/>)
    ]

  defp icon_paths("chevron-left"),
    do: [
      ~s(<path d="m15 18-6-6 6-6"/>)
    ]

  defp icon_paths("flame"),
    do: [
  ...
  defp icon_paths("more-horizontal"),
    do: [
